...
var gettoken = function(type) {
	// 本地
	/*
	 * var Client_Id = "YXA6s3jZQHkAEeSvivXzQkAWdQ";//$("#Client_Id").val(); var
	 * Client_Secret =
	 * "YXA6HIOk2xIjsQUGxMKXWXPloWc2u8M";//$("#Client_Secret").val(); var
	 * Appkey="zkim2014#stepper";//$("#Appkey").val();
	 */
	// 云端1
	/*
	 ...
	 */
	// 云端2
	var Client_Id = "YXA6QbN8AMY7EeW9iHmS69KEfQ"; // $("#Client_Id").val();
	var Client_Secret = "YXA67mn4tx10pL1_g4LDPkIAUftZI_Y"; // $("#Client_Secret").val();
	var Appkey = "zkim2014#fatburn";
...
var createMomogrouplistUL = function createMomogrouplistUL(msg) {
	...
	var headIcon1 = "img/head/contact_normal.png";
	if (msg.ext.from.headIcon) {
		// headIcon1 = headIconLoad + msg.ext.from.headIcon;
		headIcon1 = '../file/FileCenter!showImage2.zk?name=' + msg.ext.from.headIcon;
	}
	imgelem.setAttribute("src", headIcon1);
...
var appendMsg1 = function(msg) {
	...
	var headstr = [
		"<p1 style='color:#666666;'>" + msg.ext.from.userName + "   <span></span>" + "   </p1>",
		"<p2 style='color:#666666;'>" + getLoacalTimeString() + "<b></b><br/></p2>"
	];
